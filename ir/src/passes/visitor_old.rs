...
pub enum VisitOrderOld {
    Manual,
    DepthFirst,
    PostOrder,
}
pub trait VisitDefaultOld {}
pub trait VisitContextOld
where
    Self::Graph: Graph,
{
    type Graph;
...
pub trait VisitOld: VisitContextOld {
...
impl<T> VisitOld for T
where
    T: VisitContextOld + VisitDefaultOld,
    T::Graph: Graph,
{
}
