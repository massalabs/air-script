...
fn test_mutability_singletons() {
    ...
    // let's test the mutability of singletons when setting a new value of the same variant
    ...
    // let's test the mutability of singletons when setting a new value of a different variant
